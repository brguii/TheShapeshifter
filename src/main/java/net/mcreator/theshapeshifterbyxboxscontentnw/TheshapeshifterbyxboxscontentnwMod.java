 ...
 *
 */
package net.mcreator.theshapeshifterbyxboxscontentnw;
...
@Mod("theshapeshifterbyxboxscontentnw")
public class TheshapeshifterbyxboxscontentnwMod {
	public static final Logger LOGGER = LogManager.getLogger(TheshapeshifterbyxboxscontentnwMod.class);
	public static final String MODID = "theshapeshifterbyxboxscontentnw";

	public TheshapeshifterbyxboxscontentnwMod() {
