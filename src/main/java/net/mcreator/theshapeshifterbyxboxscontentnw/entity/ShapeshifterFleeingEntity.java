...
public class ShapeshifterFleeingEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShapeshifterFleeingEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ShapeshifterFleeingEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ShapeshifterFleeingEntity.class, EntityDataSerializers.STRING);
	...
	public ShapeshifterFleeingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheshapeshifterbyxboxscontentnwModEntities.SHAPESHIFTER_FLEEING.get(), world);
	}

	public ShapeshifterFleeingEntity(EntityType<ShapeshifterFleeingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(10, new AvoidEntityGoal<>(this, Player.class, (float) 48, 1, 1.2));
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShapeshifterFleeingEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
