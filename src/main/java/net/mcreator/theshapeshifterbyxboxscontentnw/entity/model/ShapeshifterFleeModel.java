...
public class ShapeshifterFleeModel extends AnimatedGeoModel<ShapeshifterFleeEntity> {
	...
	@Override
	public void setCustomAnimations(ShapeshifterFleeEntity animatable, int instanceId, AnimationEvent animationEvent) {
		super.setCustomAnimations(animatable, instanceId, animationEvent);
		IBone head = this.getAnimationProcessor().getBone("neckh");
