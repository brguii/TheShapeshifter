...
public class ShapeshifterOnWallModel extends AnimatedGeoModel<ShapeshifterOnWallEntity> {
	@Override
	public ResourceLocation getAnimationResource(ShapeshifterOnWallEntity entity) {
		return new ResourceLocation("theshapeshifterbyxboxscontentnw", "animations/shapeshifter.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(ShapeshifterOnWallEntity entity) {
		return new ResourceLocation("theshapeshifterbyxboxscontentnw", "geo/shapeshifter.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(ShapeshifterOnWallEntity entity) {
		return new ResourceLocation("theshapeshifterbyxboxscontentnw", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(ShapeshifterOnWallEntity animatable, int instanceId, AnimationEvent animationEvent) {
